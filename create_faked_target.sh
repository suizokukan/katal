...
echo
echo "(07) ../../katal/katal.py --add --move --strictcmp --configfile=../../faked/target/.katal/katal.ini"
../../katal/katal.py --add --move --strictcmp --configfile=../../faked/target/.katal/katal.ini
...
echo
echo "(14) ../../katal/katal.py --cleandbrm --configfile=../../faked/target/.katal/katal.ini"
../../katal/katal.py --cleandbrm --configfile=../../faked/target/.katal/katal.ini
...
echo
echo "(20) ../../katal/katal.py --whatabout 0.py --configfile=../../faked/target/.katal/katal.ini"
../../katal/katal.py --whatabout 0.py --configfile=../../faked/target/.katal/katal.ini

echo
echo "(20) ../../katal/katal.py --whatabout ../src/2.py --configfile=../../faked/target/.katal/katal.ini"
../../katal/katal.py --whatabout ../src/game.py --configfile=../../faked/target/.katal/katal.ini
